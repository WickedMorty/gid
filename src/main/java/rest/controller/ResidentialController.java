...
public class ResidentialController {
    ...
    public List<DataToFastSelect> getDataToFastSelect() {
        return residentialService.getAllParam();
    }

    @GetMapping("/all")
    public List<ResidentialMin> getAll() {
        return residentialService.getResidentialMin();
    }
...
//                    item = URLDecoder.decode(item);
//                    if(residential.getDeadline() != null && item != null) {
//                        if (residential.getDeadline().equals(item)) {
